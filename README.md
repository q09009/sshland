...
- CPU, 메모리, 디스크, 네트워크, 프로세스 등을 확인하는 서버 대시보드
...
- 상단바 오른쪽의 설정 버튼에서 언어, 명령 GUI, 명령 로그, 대시보드, 시계 표시를 설정할 수 있습니다.
...
- 현재 버전에는 `known_hosts` 기반 서버 호스트 키 검증 기능이 없습니다. 신뢰할 수 없는 네트워크나 서버에서는 사용하지 마세요.
